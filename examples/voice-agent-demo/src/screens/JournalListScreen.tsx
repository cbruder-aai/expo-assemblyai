...
const styles = StyleSheet.create({
  ...
  newBtnText: { color: theme.colors.cyan, fontWeight: '700', fontSize: 14 },
  ...
  rowDate: { color: theme.colors.text, fontSize: 15, fontWeight: '700' },
  rowRel: { color: theme.colors.cyan, fontSize: 12, fontWeight: '600', textTransform: 'capitalize' },
